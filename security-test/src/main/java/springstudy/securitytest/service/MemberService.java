package springstudy.securitytest.service;
...
import springstudy.securitytest.domain.Role;
import springstudy.securitytest.dto.MemberDto;
import springstudy.securitytest.repository.MemberRepository;
...
public class MemberService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // (간단하게!!) username이 admin이면 admin 권한 부여. 아니면 member 권한 부여
